...
namespace Couriers_GUI.UserInterface.Components
{
	public partial class StackPanel : UserControl
	{
		...
		public StackPanel(string header) : base()
		{
			AddHeader(header);
		}
		...
		public void AddControl(Control control)
		{
			...
			for(int i = 0; i < currRow; i++)
				tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.AutoSize, tableLayoutPanel1.GetControlFromPosition(0, i).Height));
